...
@Service
@Profile("test")
public class ExampleDynamicAggregateTypeCreateIfMissingCommandOgmProvider
    implements SpecificCommandEventGraphMappingProvider {

  public static final String COMMAND_NAME = "ExampleDynamicAggregateTypeCreateIfMissingCommand";
  ...
  public void addOgmToMap(
    ...
    definition
        .addField("data")
        .addObjectAsObjectFieldMapping()
        .addField("exampleCreateIfMissingAttribute")
        .addLeafAsObjectFieldMapping()
        .setGraphDescription(
            new GraphDescriptionBuilder()
                .addLeafAttribute("exampleCreateIfMissingAttribute")
                .addStringAttributeValue());

    map.put(
        ExampleDynamicAggregateCreatedFactory.ExampleDynamicAggregateCreated.class,
        definition.build()
    );
  }
