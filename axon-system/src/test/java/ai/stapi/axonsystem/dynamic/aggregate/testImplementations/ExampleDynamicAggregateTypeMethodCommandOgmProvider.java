...
@Service
@Profile("test")
public class ExampleDynamicAggregateTypeMethodCommandOgmProvider
    implements SpecificCommandEventGraphMappingProvider {

  public static final String COMMAND_NAME = "ExampleDynamicAggregateTypeMethodCommand";
  ...
  public void addOgmToMap(
    ...
    definition
        .addField("data")
        .addObjectAsObjectFieldMapping()
        .addField("exampleMethodAttribute")
        .addLeafAsObjectFieldMapping()
        .setGraphDescription(
            new GraphDescriptionBuilder()
                .addLeafAttribute("exampleMethodAttribute")
                .addStringAttributeValue());

    map.put(ExampleDynamicAggregateChangedFactory.ExampleDynamicAggregateChanged.class,
        definition.build());
  }
